  ...
  return (
    <section className="section__projects section__padding">
      ...
      <div className="section__projects-description">
        <Fade bottom>
          <p>
            Here are some selected and challenging real life and personal
            projects that I have worked on so far which enabled me to level up
            my skills to a fascinating point that makes me feel confident in
            tackling more difficult challenges.
          </p>
        </Fade>
      </div>
